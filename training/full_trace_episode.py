"""
Full-step trace of one goal episode to understand exact goal mechanism.
"""
import os
import sys
import torch
...
def full_trace():
    ...
    # Trace episode 0 (a known goal episode)
    seed = 500000
    ...
    print(f"=== Full trace: Episode 0 (seed {seed}) ===")
    print(f"{'Step':>4} {'BallX':>7} {'BallY':>7} {'BallZ':>7} {'Vx(real)':>9} {'Vy(real)':>9} {'Vz(real)':>9} {'Speed':>6} {'Owned':>6} {'Actions':<30} {'Event':>12}")
    print("-" * 110)
    ...
    while not done and steps < 200:
        ...
        print(f"{steps:4d} {ball_x:7.3f} {ball_y:7.3f} {ball_z:7.3f} {ball_vx:9.4f} {ball_vy:9.4f} {ball_vz:9.4f} {ball_speed:6.4f} {ball_owned:6d} {','.join(action_strs):<30} {event_str:>12}")
