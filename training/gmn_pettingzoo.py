...
class GMNMultiAgentEnv(ParallelEnv):
    ...
    def _recv_reset_response(self) -> Dict[str, Any]:
        """Receive a reset response, skipping unsolicited broadcast frames (e.g. TRAINING_STATUS) ON the shared WS."""
        for _ in range(60):
        ...
        raise RuntimeError("[GMN-PettingZoo] No reset response received (only broadcast frames)")
