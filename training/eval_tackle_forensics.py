...
class InstrumentedAdapter(AttackingDrillRewardAdapter):
    ...
    def compute_shaped_rewards(self, base_rewards, step_events, info_ground_truth, active_agents, actions=None, tick=0, max_ticks=None):
        ...
        # Call super() EXACTLY once. The parent applies _apply_action_cost,
        # _apply_possession, _handle_events, _strip_progress, PBRS, dense terms,
        # exploration bonus, etc. in a single pass. Do NOT call those helpers
        # manually here — that would double-apply shaping and corrupt deltas.
        ...
        # Capture per-agent delta vs. base snapshot
